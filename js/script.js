...
const enterFocusMode = focusedSprite => {
  ...
  const rotationTweenValue = {t: 0};
  const rotationTween = new TWEEN.Tween(rotationTweenValue)
  	.to({t: 1}, 1000)
  	.easing(TWEEN.Easing.Quartic.Out);
  rotationTween.onUpdate(() => {
  	THREE.Quaternion.slerp(originalQuaternion, tempCamera.quaternion, slerpedQuaternion, rotationTweenValue.t);
